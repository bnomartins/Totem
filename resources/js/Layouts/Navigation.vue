    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <div class="flex justify-center items-center mt-8">
            <div class="flex items-center text-2xl">
                ...
                <i class="fa-regular fa-hospital" style="color: #f4f5f6;"></i>
                <span class="mx-2 text-2xl font-semibold text-white">PRONTCenter</span>
            </div>
        </div>

        <nav class="mt-10 text-2xl" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <nav-link :href="route('pacientes.index')" :active="route().current('pacientes.index')" class="text-2xl">
                <i class="fa-solid fa-building"></i>
                Pacientes
            </nav-link>

            <nav-link :href="route('atendimentos.index')" :active="route().current('atendimentos.index')"  class="text-2xl">
                <i class="fa-solid fa-building"></i>
                Atendimento
            </nav-link>

            <nav-link :href="route('triagems.index')" :active="route().current('triagems.index')"  class="text-2xl">
                <i class="fa-solid fa-building"></i>
                Triagem
            </nav-link>

            <nav-link :href="route('clinicos.index')" :active="route().current('clinicos.index')"  class="text-2xl">
                <i class="fa-solid fa-building"></i>
                Atendimento Médico
            </nav-link>
            ...
            <nav-link :href="route('users.index')" :active="route().current('users.index')"  class="text-2xl">
                <template #icon>
            ...
            <nav-link :href="route('about')" :active="route().current('about')"  class="text-2xl">
                <template #icon>

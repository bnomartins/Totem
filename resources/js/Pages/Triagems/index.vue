    ...
    <AuthenticatedLayout>
        ...
        <div class="m-auto bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="m-5 border-b border-gray-200">
                ...
                <div class="m-2 p-2">
                    <Pagination :links="triagems.links"/>
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
...
import EdicaoTriagem from '../../Components/Triagems/Edicao.vue'
